...
# <b>Првиет {name}!!!</b>
#             Это бот, где ты можешь формировать свой список мест, которые хочешь посетить.
#             Ты можешь:
#              1) Добавлять новые места
#              2) Посмотреть весь список
#              3) Если ты не знаешь куда пойти, доверься мне! Нажмми на кнопку <u>Куда сходить?</u> и я подскажу!
#         '''
